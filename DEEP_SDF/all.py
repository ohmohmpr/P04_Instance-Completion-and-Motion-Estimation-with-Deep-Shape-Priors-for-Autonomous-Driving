...
def main(config):
    ...
    for frame_id, obj_opt_accu_opt in objects_recon_opt_accu_opt.items():
        ...
        obj.g_pose_mesh = obj_opt_accu_opt.g_pose @ rott @ obj.t_cam_obj
        obj.s_pose = obj_opt_accu_opt.s_pose
        obj.s_pose_mesh = obj_opt_accu_opt.s_pose @ rott @ obj.t_cam_obj

        print("obj.g_pose", obj.g_pose)
        print("obj.s_pose", obj.s_pose)
