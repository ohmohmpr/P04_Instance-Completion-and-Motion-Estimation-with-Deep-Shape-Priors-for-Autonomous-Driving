...
class FrameWithLiDAR:
    ...
    def get_detections(self, detections_bboxs):
        ...
        # print("detections_bboxs", detections_bboxs)
        ...
        for frame_id, det in detections_bboxs.items():
            x = det.s_pose_visuals.x
            y = det.s_pose_visuals.y
            z = det.s_pose_visuals.z
            l = det.s_pose_visuals.length
            w = det.s_pose_visuals.width
...
class KITIISequence:
    def __init__(self, data_dir, configs):
        ...
        self.load_calib()
        self.num_frames = len(os.listdir(self.velo_dir))
    ...
    def get_frame_by_id(self, frame_id, detections_bboxs):
        ...
        self.current_frame.get_detections(detections_bboxs)
